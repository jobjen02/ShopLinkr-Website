...
export const faqsByPage: Record<string, Array<FaqItem>> = {
    ...
    producten: [
        ...
        },
        {
            ...
            answer: "De bundelvoorraad volgt altijd het scharste onderdeel. Verkoop je een component los, dan zakt de bundelvoorraad mee, zodat je nooit meer bundels aanbiedt dan je kunt samenstellen. Een product mag in meerdere bundels tegelijk voorkomen en blijft daarnaast los verkoopbaar.",
        },
        {
    ...
    picklijsten: [
        {
            ...
            answer: "Heb je veel orders met maar één product, zoals brievenbuspakketten? Dan filter je apart op single bestellingen en verwerk je ze in bulk. Een picklijst zonder bakken werkt prima bij kleinere batches waar je alles in één grote bak verzamelt. Bij grotere volumes of orders met meerdere producten geven bakken net die extra controle die fouten voorkomt.",
        },
        {
            question: "Werkt Auto Print met elke printer?",
            answer: "Auto Print werkt met vrijwel elke printer en herkent je apparaten automatisch zodra je de koppeling installeert. Je koppelt elke printer aan een inpakstation, zodat de labels altijd op de juiste plek uitrollen. Voor Zebra-printers raden we ZPL-modus aan met snelheid 2 en densiteit 5 voor de beste afdrukkwaliteit.",
        },
        {
            question: "Wat zijn bakken en wanneer is het de moeite waard om ermee te werken?",
            answer: "Bakken zijn fysieke kratten met een unieke barcode die je tijdens het picken aan een bestelling koppelt. Je maakt ze in bulk aan via de wizard en print de barcodelabels uit ShopLinkr. Werk je met orders die uit meerdere producten bestaan of pick je in grotere batches, dan voorkomt het bakkensysteem dat producten in de verkeerde doos belanden.",
        },
        {
            question: "Welke hardware heb ik nodig om te kunnen picken?",
            answer: "Een handscanner. Je ziet per stap welk product je moet pakken en waar het ligt in je magazijn, en na elke succesvolle scan verschijnt het volgende product. Een tablet of computer werkt prima om de picklijst weer te geven, maar voor de scans zelf is een echte handscanner nodig.",
        },
        {
    ...
    leveringen: [
        ...
        },
        {
            ...
            answer: "Tijdens het ontvangen vul je per regel het werkelijke aantal in. Het verschil blijft staan onder Verwacht, zodat je het later alsnog kunt ontvangen als er nog wat nakomt. Rond je de levering af terwijl er regels openstaan, dan vind je die terug onder Niet ontvangen.",
        },
        {
        ...
        },
        {
            ...
            answer: "Ja. Heb je per ongeluk een product ontvangen of de verkeerde locatie gekozen, dan kun je de ontvangst ongedaan maken. De voorraad wordt weer afgeschreven van de locatie en het product schuift terug naar Verwacht, zodat je het opnieuw kunt ontvangen.",
        },
        {
            question: "Hoe koppel je een levering aan een specifieke opslaglocatie?",
    ...
    retouren: [
        {
            question: "Welke verkoopkanalen worden ondersteund voor retouren?",
            answer: "Retouren verwerk je op dit moment voor Bol. Je bestellingen en voorraad blijven uiteraard synchroon op al je andere kanalen.",
        },
        {
            question: "Kan ik per item bepalen of het terug op voorraad gaat?",
            answer: "Ja. Tijdens het verwerken zet je per item de schakelaar Toevoegen aan voorraad aan of uit en kies je de magazijnlocatie. Bij bundelproducten stel je per subproduct apart een locatie in. Zet je een item niet terug op voorraad, dan blijft het buiten je verkoopbare voorraad.",
        },
        {
            question: "Kan ik foto's toevoegen aan een retour?",
            answer: "Ja, je voegt maximaal drie foto's per retouritem toe. Handig als bewijs bij beschadigde of incomplete retouren, bijvoorbeeld bij een geschil met een klant of om intern vast te leggen in welke staat een product binnenkwam.",
        },
        {
            question: "Kan ik de retourstatus zelf kiezen, bijvoorbeeld gegrond of ongegrond?",
            answer: "Ja, je kiest per retouritem de retourstatus. Welke opties je krijgt, wordt bepaald door Bol, zodat je altijd binnen hun regels blijft.",
        },
        {
            question: "Wat gebeurt er met de status op het verkoopkanaal?",
            answer: "Zodra je een retour verwerkt, koppelt ShopLinkr de verwerking automatisch terug naar Bol. Jij hoeft daarvoor niet apart in te loggen. Je voorraad gaat in dezelfde beweging mee, zodat al je gekoppelde kanalen meteen de actuele aantallen zien.",
        },
    ],
    vervoerders: [
        {
            question: "Welke vervoerders worden ondersteund?",
            answer: "Een breed aanbod, waaronder PostNL, DPD, GLS, Sendcloud, MyParcel, Innosend, QLS, ParcelPro, Sendy, PakketMail, DeliveryMatch, EctaroShip, TransMission en Zineps. Je koppelt zoveel vervoerders als je nodig hebt en kiest per bestelling de juiste. De volledige lijst en de koppelinstructies per vervoerder vind je op de integraties-pagina.",
        },
        {
        ...
        },
        {
            ...
            answer: "AutoPrint stuurt verzendlabels automatisch naar de printer bij je inpakstation zodra je een bestelling verwerkt. Daarvoor gebruiken we PrintNode, een softwaretool die je installeert op een computer in je magazijn. PrintNode draait op de achtergrond en pikt elk nieuw label op, zodat je niet meer per order op print hoeft te klikken.",
        },
        {
            question: "Kun je per bestelling een andere vervoerder kiezen?",
            answer: "Ja. Zolang de vervoerder gekoppeld is, kies je per bestelling welke je gebruikt. Wil je dat niet handmatig doen? Met een verzendregel laat je ShopLinkr automatisch de juiste vervoerder selecteren op basis van gewicht, bestemming, kanaal of producttype.",
        },
        {
            question: "Werkt track en trace automatisch terug naar je kanaal?",
            answer: "Ja. Zodra het label is aangemaakt, stuurt ShopLinkr de track en trace code automatisch terug naar het kanaal waar de bestelling vandaan kwam. Je verkoopkanaal ontvangt de code en je klant krijgt op de bekende manier de bezorgupdate.",
        },
        {
    ...
    locatiebeheer: [
        ...
        },
        {
            ...
            answer: "Ja. Op de bestellingenpagina staat per regel de locatie van het product, en op de picklijst zie je voor elk artikel waar het ligt. Of je nu losse orders verwerkt, een batch samenstelt of via een inpakstation werkt: de locatie reist mee.",
        },
        {
            question: "Hoe verplaats ik voorraad van de ene locatie naar de andere?",
            answer: "Open het product, klik op Voorraad bijwerken en kies Verplaatsen. Selecteer de bronlocatie, de doellocatie en het aantal stuks. Wil je alles overzetten? Zet dan de schakelaar Alle voorraad verplaatsen aan. De mutatie verschijnt meteen in de voorraadhistorie van het product.",
        },
    ],
    inkoopadvies: [
        {
    ...
    rapporten: [
        ...
        },
        {
            ...
            answer: "Ja, elk rapport heeft een exportknop. Je krijgt het bestand per e-mail zodra het klaar is, zodat zware exports je browser niet bezighouden. Handig om door te sturen naar je boekhouder of mee te nemen in je eigen analyse.",
        },
        {
    ...
    regels: [
        {
            question: "Op welke voorwaarden kan ik een regel laten triggeren?",
            answer: "Op tientallen velden, verdeeld over klantgegevens en bestelling. Denk aan verkoopkanaal, totaalgewicht, totaalbedrag, aantal producten, verpakkingstype, specifiek product, tag, servicepunt, verzendmethode en besteldatum. Voor klantgegevens kies je per veld of het om het verzendadres of factuuradres gaat, en daarbinnen om naam, e-mail, postcode, land, Waddeneilanden en meer.",
        },
        {
            question: "Welke acties kan ShopLinkr automatisch uitvoeren?",
            answer: "Negen verschillende. Een verzendoptie instellen, tags toevoegen, een notitie plaatsen, de bestelling uitstellen, markeren als hoge prioriteit of als afhaalbestelling, een uiterste verwerkingsdatum zetten, een product aan de bestelling toevoegen, of automatische verwerking in de picklijst uitschakelen. Je kunt meerdere acties combineren binnen één regel.",
        },
        {
            question: "Kan ik meerdere voorwaarden in één regel combineren?",
            answer: "Ja. Binnen een groep voorwaarden bepaal je of alle voorwaarden moeten kloppen, of dat één voorwaarde al voldoende is. Zo maak je een regel die alleen triggert bij een specifieke combinatie, of juist een regel die meerdere situaties tegelijk afvangt.",
        },
        {
    ...
    klanten: [
        ...
        },
        {
            ...
            answer: "Aanhef, voor- en achternaam met eventueel tussenvoegsel, e-mailadres, telefoonnummer, bedrijfsnaam, btw- en KvK-nummer, plus een volledig adres met straat, huisnummer, postcode, plaats en land. Alle persoonsgegevens worden versleuteld opgeslagen.",
        },
        {
            question: "Kan ik orders van dezelfde klant samenvoegen tot één zending?",
            answer: "Ja, op basis van het afleveradres. Hebben meerdere openstaande bestellingen hetzelfde verzendadres, dan herkent ShopLinkr dat en kun je ze samenvoegen tot één zending. Dat werkt ook als de orders van verschillende verkoopkanalen komen.",
        },
    ],
    prijzen: [
        {
        ...
        },
        {
            ...
            answer: "Toegang tot onze chat en mail support, met een reactietijd van doorgaans onder de 24 uur. Geen tickets in een wachtrij, geen losse support-pakketten. Voor inrichtingsvragen plannen we ook graag een korte call.",
        },
        {
    ...
    contact: [
        {
            ...
            answer: "Tijdens kantooruren reageren we doorgaans binnen een uur. Stuur je iets in het weekend? Dan hoor je vrijwel altijd op maandagochtend van ons.",
        },
        {
            question: "Kan ik ook bellen of via WhatsApp?",
            answer: "Bellen kan op +31 6 49 78 12 12, maandag tot en met vrijdag van 08:30 tot 17:00. Voor korte vragen werkt mailen of het formulier vaak sneller, omdat we dan direct kunnen meekijken.",
        },
        {
        ...
        },
        {
            ...
            answer: "Je kan 14 dagen gratis ShopLinkr proberen, zonder creditcard. Lopen we ergens samen tegenaan, dan staan we klaar.",
        },
    ],
};
