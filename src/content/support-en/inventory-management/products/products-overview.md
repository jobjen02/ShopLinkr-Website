...
summary: "Everything you see and can do on the products page."
...
<p>The products page brings all your products together in one place. From here you can view products, update stock, and import and export them.</p>
<h3>What does each product show?</h3>
<p>Every product displays the following information:</p>
<ul>
<li>
<p><strong>Title</strong>: the name of the product, along with its SKU number and packaging type</p>
</li>
<li>
<p><strong>EAN</strong>: the product's EAN code (click to copy)</p>
</li>
<li>
...
<h3>Filtering</h3>
<p>You can filter products by:</p>
<ul>
<li>
...
<h3>Actions</h3>
<p>From the overview you can carry out the following actions:</p>
<ul>
<li>
<p><strong>Update stock</strong>: adjust a product's stock, move stock to another location, or set the stock to a specific amount</p>
</li>
<li>
...
<li>
<p><strong>Bulk actions</strong>: adjust packaging type, tags, or costs in bulk</p>
</li>
</ul>
