...
excerpt: "Connect Sendy to Shopify through ShopLinkr. Your orders come in automatically, you print shipping labels and track and trace flows back to your store."
...
<li><p><strong>Tracking sent back</strong>: as soon as the label exists, ShopLinkr returns the track and trace to Shopify, so your customer stays informed.</p></li>
</ul>
<p>Sendy is shipping software that bundles several carriers such as PostNL, DHL and DPD. Besides Sendy, you can connect other carriers in ShopLinkr too, so you pick the option that fits each order best.</p>

<h2>Connect Sendy to Shopify in 5 steps</h2>
<p>Here is how to set up the connection:</p>
<ol>
...
<p>For the workflow in this guide, yes. ShopLinkr processes your Shopify orders and sends the track and trace back, while Sendy supplies the labels. That combines order processing and shipping into a single workflow.</p>
<h3>My Shopify orders don't show up in ShopLinkr. What now?</h3>
<p>Check that your Shopify store is connected correctly as a sales channel and that the connection is active. Once the details are right, new orders come in on their own.</p>
