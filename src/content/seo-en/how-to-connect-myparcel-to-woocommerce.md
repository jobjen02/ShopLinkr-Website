...
excerpt: "Connect MyParcel to WooCommerce through ShopLinkr and ship every order with MyParcel labels. A simple step-by-step setup with automatic track & trace."
...
imageAlt: "Connecting MyParcel to a WooCommerce webshop through ShopLinkr"
translationKey: "hoe-koppel-ik-myparcel-met-woocommerce"
---

<p>Want to connect MyParcel to WooCommerce? The fastest route is through ShopLinkr. You link your WooCommerce store and your MyParcel account once, and after that you print a MyParcel shipping label for every order with a single click. ShopLinkr pulls in your WooCommerce orders automatically and sends the track & trace straight back to your store, so your customer is informed right away.</p>
...
<p>Bringing MyParcel and WooCommerce together in ShopLinkr lets you process orders faster and with fewer mistakes. Specifically:</p>
<ul>
...
<h3>Do I need a MyParcel plugin in WordPress?</h3>
<p>No. The connection between WooCommerce and MyParcel runs through ShopLinkr. You link both accounts once and handle everything inside ShopLinkr after that.</p>
